...
Fatigue in basketball is a broadly analysed topic in physiological research. Latest literature suggests that there is no 
...
```{r}
# Pick out 3 of the best players in that regular season and create a new subset. Analyse how shooting percentage of these players can influence the result of a match.

top.scorers.list <- c("mnta ellis", "lebron james", "james harden", "russell westbrook", "stephen curry", "anthony davis", "blake griffin", "lamarcus aldridge", "dwayne wade", "carmelo anthony", "nikola vucevic", "eric bledsoe", "demarcus cousins", "kawhi leonard", "gordon hayward", "john wall") # players picked out
...
ggplot(top.scorers2) + geom_boxplot(aes(x = player_name, y = FGA, colour = W))
ggplot(top.scorers2) + geom_boxplot(aes(x = player_name, y = FG.percentage, colour = W)) 
