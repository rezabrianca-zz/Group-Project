...
```{r, echo=FALSE}
graph01 <- ggplot(special2) + geom_boxplot(aes(x = player_name, y = FGA, colour = W))+ graph01 + labs(title = "Differences in FGA for games lost/won for particular players") + xlab("Player name") + ylab("FGA")
