...
#plot the graph
library(ggplot2)
ggplot(data = top5_2points, aes(x = top5Players2)) + geom_bar(aes(x = top5players2, y = top5Counter), stat = "identity")
...
#plot the graph
library(ggplot2)
ggplot(data = top5_3points, aes(x = top5Players3)) + geom_bar(aes(x = top5Players3, y = top5Counter3), stat = "identity")
