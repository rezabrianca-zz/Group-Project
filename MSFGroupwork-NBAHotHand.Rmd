...
###Future research
  ...
  Since the dataset is reffered to only one season and is not able to eliminate the hot hand theory, it would be an interesting topic to be investigated in future seasons. 
