...
=======
#t.test(x=restdays2$W[restdays2$rest==0], y= restdays2$W[restdays2$rest==1])
>>>>>>> 334f80c223b5add4579e9efe4c07028e7197c743
...
####Plot Result
  The streak length distributions are quite similar, so it can be concluded that Kyrie Irving doesn't have a hot hand.
...
####Plot Result
  ...
  The streak length distributions are quite similar, so it can be concluded that Mo Williams doesn't have a hot hand.
