...
h. Fatigue Effect (Number of Rest Day)  
i. Regression Analysis (Alex)
>>>>>>> 55c718a381bf6c1f8659c54b51903d2b25b3ca28
...
I   Describe the dataset:
    ...
    Data on shots taken during the NBA 2014-2015 season for regular matches throughout the year. This comprehensive data comprise of 128,609 rows and 22 columns with 16 MB data size with only several value in a column is missing (shot clock). The column titles are generally self-explanatory. It has the following data:  
    1.  Match ID  
    2.  Match date  
    3.  Which team plays as home and away  
    4.  Match result  
    5.  Final score difference  
    6.  Every shots per game for each player  
    7.  Shot result whether it is success or not  
    8.  Shot attempt for 2 points or 3 points  
    9.  What is the game clock  
    10. How much time left for a shot (shot clock)  
    11. Who took the shot  
    12. Shot distance from basket  
    13. Who was the nearest defender  
    14. Distance from the nearest defender  
...
distance_level$Accuracy <- round(distance_level$SCORED / distance_level$Freq, 2)
