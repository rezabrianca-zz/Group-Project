...
The graph below shows descriptive variables for home/away wins:
...
The measurements are calculated in the following steps:
  ...
  6. A logistic regression with the outcome of the match as dependent variable and FGA and percentage of FG made as independent variables. 
  7. Another logistic regression test was run in order to examine three special players: Russell Westbrook, Kawhi Leonard and Gordon Hayward. 
