...
for i in aa3$TEAM {
  for (j in 1:nrow(restdays)) {aa3$DATES<- as.list(aa3$DATES)
    if (restdays$HOME_TEAM[j]=="LAL" ) aa3$DATES[aa3$TEAM=="LAL"]<- c(aa3$DATES[aa3$TEAM=="LAL"], restdays$DATE[j])}
}

#| restdays$AWAY_TEAM[j])=="LAL"
