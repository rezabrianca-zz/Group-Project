...
df[, "SHOT_CLOCK_NONA"] <- df[, "SHOT_CLOCK"]
is.na(df$SHOT_CLOCK_NONA) <- 99

acc_sec24 <- as.numeric
acc_sec24 <- sum(df$SHOT_CLOCK > 23 & df$FGM == 1) / sum(df$SHOT_CLOCK > 23)
...
>>>>>>> e982bfd9f4a1e3a1ea8059f5def6aa304f99f0ec
