...
The NULL Hypothesis: Analysis of means for home and away wins does not show any significant difference in the means.
>>>>>>> 48af33f906fad6f1db8c4b257aaeccfc2ac89cc6
...
graph01 <- graph01 + labs(title = "Differences in FGA for games lost/won /n of the three special players") + xlab("Player name") + ylab("FGA")
graph02 <- ggplot(special2) + geom_boxplot(aes(x = player_name, y = FG.percentage, colour = W)) 
graph02 <- graph02 + labs(title = "Differences in FG% for games lost/won /n of the three special players") + xlab("Player name") + ylab("FG%")
...
The steps to calculate this measurement are as follows:  
  ...
  6. Seperate data in two ranges - 0 to 8 feet distance and above 8 feet distance
...
**Table 13**: The relationship between the shooter distance ranges and accuracy
...
<<<<<<< HEAD
  ...
  The analysis aims to investigate whether the effect of the 'hot hand theory' is valid based on the given dataset. The 'hothand theory' states that if the shooter makes his first shot, the probability of making his next shot is higher. (Gilovich, T., Vallone, R. and Tversky, A. (1985))
  
=======
  The analysis aims to investigate whether the effect of the 'hot hand theory' is valid based on the given dataset. The 'hothand theory' states that if the shooter makes his first shot, the probability of making his next shot is higher. 
  
  The specific analysis aims to show the effect of the 'hot hand theory' on NBA players. The analysis is aimed to establish whether there are  the hypothesis that a shooter with a hot hand will have shots that are dependent of one another. If the shooter makes his first shot, the probability of making his next shot is higher.
>>>>>>> 48af33f906fad6f1db8c4b257aaeccfc2ac89cc6
...
###Future research
  ...
  Since the dataset is reffered to only one season and the analysis is not able to eliminate the hot hand theory, it would be an interesting topic to be investigated by using data from more than one season. 
