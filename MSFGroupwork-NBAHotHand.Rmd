...
```
Diagram xx1: Differences in FGA for games lost/won of the three special players.
```{r, echo=FALSE}
...
```
Diagram xx2: Differences in FG% for games lost/won of the three special players.
