...
graph01 <- graph01 + labs(title = "Differences in FGA for games lost/won for particular players") + xlab("Player name") + ylab("FGA")
graph02 <- ggplot(special2) + geom_boxplot(aes(x = player_name, y = FG.percentage, colour = W)) 
graph02 <- graph02 + labs(title = "Differences in FG% for games lost/won for particular players") + xlab("Player name") + ylab("FG%")
...
**Table 14**: The relationship between the shooter distance ranges and accuracy
