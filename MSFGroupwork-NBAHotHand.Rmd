...
Literature review demonstrated that a team playing at home is more likely to win with an average probability of the home win is around XXXX percent. It is also important to note that there a trend developed in last few years, which indicates that win probability of a team playing at home has reduced from around 65% from 1975-1992 to 60% since then and to 57.4% win in 2014-2015 season. (http://www.economist.com/blogs/gametheory/2015/06/home-advantage-basketball) As a result, part of this research is aimed at analysing whether home team advantage was statistically evident in season 2015-2016. 
...
The steps to calculate this measurement are as follows:  
    ...
    6. Propose areas of further research (DO I NEED IT HERE???)
...
The analysis shown that there is a clear evidence of a team playing at home is more likely to win with an average win probability of 55.97%
...
#Create a function that gives a vector with the number of total streaks(from all players and for all games)
...
#Create a function that gives a vector of streaks for a specific player and game
...
#Create a list that gives the streaks of each player and game (3 best performances)
...
#Remove 0 from streak_per_player in order to show only the streaks achieved (streaks >= 1)
...
#Create a data frame for the streaks of each one of the 3 players (cannot create a data frame including all of them, because each list has different length)
...
Outcome for Klay Thompson:
  ...
  3. Extremely high streak - Streak length of 13 
