...
The NULL Hypothesis is: Teams performance at home is more likely to win at home then when playing away.
...
The plot shows that out of 30 teams:
  ...
  2 teams home and away win ratios are almost equal (difference of less than 0.01%)
...
The analysis shown that there is a clear evidence of a team playing at home is more likely to win with an average win probability of 55.97%. The same conclusion is evident from the analysis on a team level where 25 teams are clearly winning more games at home and away. The result shown that the NULL hypothesis should be rejected as a team playing at home is more likely to win then an away team. Regression analysis shown that playing at home gives teams on average additional 4.29 margin points. 
...
TO INCLUDE THE TABLES FROM THE ABOVE CODE
...
To better understand effects of rest and home/away advantage it would be interesting to take into account distances the teams have to travel between the games. For example if a team is travelling from one coast to another- it is likely to affect them more comparing to a team from New York travelling to play an away gamein New Jersey
